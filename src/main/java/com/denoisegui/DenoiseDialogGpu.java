...
public class DenoiseDialogGpu extends JDialog
	implements ChangeListener, ActionListener, ItemListener, WindowListener, TextListener, Runnable
{
	...
	private String  defaultMessage  = "(c) 2021 CUHK, EPFL (gpu)";
    ...
    private int         Nmin = 16;
    private DenoisingGpu   denoising;
    ...
    */
    ...
    public DenoiseDialogGpu(CLIJ2 clij2) {
        super(new Frame(), "PureDenoise");
        this.clij2=clij2;
        walk.fillAbout(
                "PureDenoise",
...
//        nye = (int)(Math.ceil((double)ny/Nmin)*Nmin);
        ...
        denoising  = new DenoisingGpu(original,AlphaHat,DeltaHat,SigmaHat,checkAutomatic.isSelected(),CS,NBFRAME, this.clij2);
