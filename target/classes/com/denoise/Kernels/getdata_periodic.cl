                      ...
                      )
{
    ...
    const int4 src_id = (int4)((x+src_start_x+nx)%nx,(y+src_start_y+ny)%ny,(z+src_start_z+nz)%nz,0);
    const int4 dst_id = (int4)((x+dst_start_x+nx)%nx,(y+dst_start_y+ny)%ny,(z+dst_start_z+nz)%nz,0);
