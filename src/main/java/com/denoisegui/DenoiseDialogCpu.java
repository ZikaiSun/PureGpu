...
public class DenoiseDialogCpu extends JDialog
	implements ChangeListener, ActionListener, ItemListener, WindowListener, TextListener, Runnable
{
	...
	private String  defaultMessage  = "(c) 2021 CUHK, EPFL (cpu)";
    ...
    private int         Nmin = 16;
    private DenoisingCpu denoising;
    ...
    private TimerCpu       	timer;

    /**
    * Constructor creates the dialog box.
    */
    public DenoiseDialogCpu() {
        super(new Frame(), "PureDenoise");
        walk.fillAbout(
                "PureDenoise",
                "Version 04/09/2021",
                "Biomedical Image Denoising (GPU)",
                "Zikai Sun, Thierry Blu, Florian Luisier",
                "The Chinese University of Hong Kong (CUHK) <br> Biomedical Imaging Group (BIG)<br>Ecole Polytechnique F&eacute;d&eacute;rale de Lausanne (EPFL)<br>Lausanne, Switzerland",
                "2021",
        ...
        sldCyclespin.setMinimumSize(new Dimension(150,50));
        sldCyclespin.setPreferredSize(new Dimension(150,50));
        ...
        sldMultiframe.setMinimumSize(new Dimension(150,50));
...
//        original = original.convert(ImageWare.SHORT);
        denoising  = new DenoisingCpu(original,AlphaHat,DeltaHat,SigmaHat,checkAutomatic.isSelected(),CS,NBFRAME);
    ...
    */
    public void run() {
        ...
        timer = new TimerCpu(walk, denoising);
        timer.start();
        denoising.perform();
        timer.stop();
